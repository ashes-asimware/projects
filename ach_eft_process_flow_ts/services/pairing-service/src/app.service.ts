...
const PUBLISH_EVENT_TYPE = 'EFTMatchedToRemittanceV1';
const PUBLISH_TOPIC = KafkaTopics.eftMatched;
const CONSUME_TOPICS = [KafkaTopics.eftReceived, KafkaTopics.remittanceReceived];

@Injectable()
export class AppService implements OnModuleInit {
  private readonly logger = createLogger('pairing-service');
