...
const PUBLISH_EVENT_TYPE = 'ProviderPayoutInitiatedV1';
const PUBLISH_TOPIC = KafkaTopics.payoutInitiated;
const CONSUME_TOPICS = [KafkaTopics.eftMatched];

@Injectable()
export class AppService implements OnModuleInit {
  private readonly logger = createLogger('ledger-service');
