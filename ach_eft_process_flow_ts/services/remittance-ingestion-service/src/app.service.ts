...
const PUBLISH_EVENT_TYPE = 'RemittanceReceivedV1';
const PUBLISH_TOPIC = KafkaTopics.remittanceReceived;
const CONSUME_TOPICS = [];

@Injectable()
export class AppService implements OnModuleInit {
  private readonly logger = createLogger('remittance-ingestion-service');
