...
const PUBLISH_EVENT_TYPE = 'BankStatementReceivedV1';
const PUBLISH_TOPIC = KafkaTopics.bankStatement;
const CONSUME_TOPICS = [KafkaTopics.payoutSent];

@Injectable()
export class AppService implements OnModuleInit {
  private readonly logger = createLogger('bank-statement-service');
