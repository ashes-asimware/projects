...
const PUBLISH_EVENT_TYPE = 'ReconciliationCompletedV1';
const PUBLISH_TOPIC = KafkaTopics.reconciliationCompleted;
const CONSUME_TOPICS = [KafkaTopics.bankStatement, KafkaTopics.payoutSent];

@Injectable()
export class AppService implements OnModuleInit {
  private readonly logger = createLogger('reconciliation-service');
